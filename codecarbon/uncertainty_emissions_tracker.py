...
class UncertaintyAwareEmissionsTracker(BaseEmissionsTracker):
    ...
    def _prepare_emissions_data(self) -> UncertaintyAwareEmissionsData:
        ...
        if self._last_uncertainty_summary and self.enable_uncertainty:
            uncertainty_emissions_data.set_uncertainty_data(
                self._last_uncertainty_summary
            )
            uncertainty_emissions_data.energy_uncertainty_pct = (
                self.energy_uncertainty_pct
            )
            uncertainty_emissions_data.carbon_intensity_uncertainty_pct = (
